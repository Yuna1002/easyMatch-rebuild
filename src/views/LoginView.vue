...
<template>
  <main class="bg-gradient d-flex justify-content-center align-items-center">
    <form class="bg-light px-22 py-15 rounded-3 shadow d-flex flex-column align-items-center">
      ...
      <button type="submit" class="btn btn-primary text-white rounded-pill py-2 mb-3" style="font-family: 'Josefin Sans'" @submit.prevent="signIn">
        SIGN IN
      </button>
